...
public class WorkblockPK implements Serializable {
    ...
    public String toString() {
        return "si.fri.tpo.gwt.server.jpa.WorkblockPK[ workblockId=" + workblockId + ", workloadWorkloadId=" + workloadWorkloadId + ", workloadTaskTaskId=" + workloadTaskTaskId + ", workloadTaskUserStoryStoryId=" + workloadTaskUserStoryStoryId + ", workloadUserUserId=" + workloadUserUserId + " ]";
    }

function dscrum(){
  ...
  if (!isHostedMode()) {
    try {
      ...
      unflattenKeylistIntoAnswers([$intern_45, $intern_45, $intern_66], $intern_100 + $intern_79);
      unflattenKeylistIntoAnswers([$intern_45, $intern_45, $intern_72], $intern_100 + $intern_80);
